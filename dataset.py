...
class BilingualDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        enc_num_padding_tokens = self.seq_length - len(enc_inp_tokens)
        dec_num_padding_tokens = self.seq_length - len(dec_inp_tokens)
        ...
        # Sanity check
        assert enc_input.shape[0] == self.seq_length
        assert dec_input.shape[0] == self.seq_length
